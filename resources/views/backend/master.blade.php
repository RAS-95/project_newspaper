...
<body class="sb-nav-fixed">
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <div class="sb-sidenav-menu-heading">All Post</div>
                        ...
                        <div class="collapse" id="collapseCategory" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link" href="{{ route('manageCategory') }}">Manage Category</a>
                                {{-- <a class="nav-link" href="{{ route('editCategory') }}">Edit Category</a> --}}
                            </nav>
                        </div>
                        ...
                        <div class="collapse" id="collapsePost" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link" href="{{ route('managePost') }}">Manage Post</a>
    ...
    <script src="{{ asset('') }}backend/https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.8.0/Chart.min.js"
